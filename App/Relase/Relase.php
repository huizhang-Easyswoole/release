...
class Relase extends AbstractProcess
{
    ...
    protected function run($arg)
    {
        go(static function () {
            ...
            {
                Coroutine::sleep(5);
                error_log('开始检测代码是否更新7'.PHP_EOL, 3, '/Users/yuzhao3/sites/es-log.log');
                ...
                if ($pullResult !== '') {
                    ...
                    $cloneExec = "sudo git clone https://github.com/huizhang-Easyswoole/release.git {$newVersionPath};cd {$newVersionPath};composer update;";
